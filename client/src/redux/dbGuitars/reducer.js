...
const guitarReducer = (state = INITIAL_STATE, action) => {
  switch(action.type){
    case 'SET_ACOUSTIC_GUITARS':
      return {
        acousticGuitarArray: action.payload,
        electricGuitarArray: [...state.electricGuitarArray]
      }
    case 'SET_ELECTRIC_GUITARS':
      return {
        acousticGuitarArray: [...state.acousticGuitarArray],
        electricGuitarArray: action.payload
      }  
    default:
      return state
  }
